...
const styles = StyleSheet.create({
  ...
  dropdownTitle: { fontSize: 14, fontWeight: '600', color: 'black', textAlign: 'center', marginBottom: 6 },
  dropdownItemText: { fontSize: 16, color: 'black', },
  ...
  langButton: { paddingVertical: 6, paddingHorizontal: 12, borderRadius: 6, backgroundColor: '#166534', width: '80%', alignItems: 'center' },
  ...
  menuText: { fontSize: 14, color: 'black', fontWeight: '500', textAlign: 'center' },
