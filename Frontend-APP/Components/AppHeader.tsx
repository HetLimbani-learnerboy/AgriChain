...
const styles = StyleSheet.create({
  navbar: {
    ...
    flexDirection: 'row',
    alignItems: 'flex-end',
    paddingHorizontal: screenWidth < 400 ? 15 : 20,
    paddingVertical: 8,
    shadowColor: '#000',
  ...
  burgerButton: { marginTop:12, marginLeft:120, padding: 5 },
  burgerText: { fontSize: 28, color: '#1E2B21' },
  logoContainer: { flexDirection: 'row', alignItems: 'center', marginLeft: 10 },
  logoImage: { width: 30, height: 30, marginRight: 6, borderRadius: 20 },
  navTitle: { fontSize: 18, fontWeight: '600', color: '#3d9369ff' },
  settingsButton: { padding: 8,   },
  settingsIcon: { width: 28, height: 28,borderRadius: 20, marginTop:1,marginBottom:-5, marginLeft:0,  },
  dropdownMenu: {
    position: 'absolute',
    top: 50,
    right: 0,
